  ...
  return [
    {
      ...
      description: "Watch the latest promo video for 30 seconds to earn points.",
      type: "watch-video",
      rewardPoints: 10,
      durationMin: 1,
      link: "#",
    ...
    },
    {
      ...
      description: "Visit our partner site and stay for at least 60 seconds.",
      type: "visit-website",
      rewardPoints: 15,
      durationMin: 2,
    ...
    {
      id: "t_3",
      title: "Read EarnCoin Article",
      description: "Read our latest blog article to claim your reading reward.",
      type: "read-article",
      rewardPoints: 12,
      durationMin: 3,
      link: "#",
    ...
    {
      id: "t_4",
      title: "Complete Lifestyle Survey",
      description: "Answer 5 short questions in our lifestyle survey.",
    ...
    {
      id: "t_5",
      title: "Follow EarnCoin on X",
      description: "Follow our official X account and engage with the latest post.",
      type: "social-follow",
      rewardPoints: 20,
      durationMin: 1,
      link: "https://x.com",
    ...
    },
    {
      ...
      description: "Share our latest campaign post on any social platform.",
      type: "share-content",
      rewardPoints: 25,
      durationMin: 1,
      link: "#",
    ...
    },
    {
      ...
      description: "Join our official Telegram channel for announcements and rewards.",
      type: "join-telegram",
      rewardPoints: 18,
      durationMin: 1,
    ...
    },
    {
      ...
      description: "Join our Discord community to unlock extra tasks.",
      type: "join-discord",
      rewardPoints: 18,
      durationMin: 1,
